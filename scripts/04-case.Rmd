...
# dica1: filtrar NAs. use a funcao 'is.na()' e o operador logico '!'
# dica2: fazer grafico com ggplot(), aes(), geom_point()
# dica3: dar uma ajeitada no grafico com labs(x = "Nota IMDB", y = "Lucro")
# dica4: dar uma ajeitada no grafico com scale_y_continuous(labels = scales::dollar_format(big.mark = "."))
# dica5: solicitar ao professo para mostrar o stat_smooth(method = "lm", se = FALSE, color = "darksalmon")
...
```{r}
# dica1: copiar e colar codigo do grafico anterior e mudar os parametros de acordo.
```
...
imdb_genero %>%
  ...
  # colocar o geom_* correspondente aqui...
...
#   ) %>%
#   # agrupar por genero.
#   # calcular a proporcao de outliers por genero. dicas: summarise, mean, na.rm = TRUE.
...
# pegar (filtrar) apenas o ator que mais fez filte com cada diretor
...
<h4>
A Curso-R agradece a turma de Introdução ao R 201907 pela participação, pelo carinho e pelo aprendizado.
</h4>
